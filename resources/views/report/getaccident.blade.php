...
<div class="content-wrapper" ng-app="tutapos">
    ...
    <section class="content">
                        ...
                        <ul class="nav navbar-nav">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="#" onclick="exportTableToCSV('Accident Report.csv')" id="excel" class="excel" style="color:#006600"><i class="fa fa-file-excel-o"></i> {{__('To Excel')}}</a></li>
        ...
        <form name="accidentform" id="accidentform">
        @csrf
            <div class="col-md-3">
...
<script type="text/javascript">
     ...
     $('#accidentform').on("submit", function(event){ 
        ...
        $.ajax({  
             url:"/reports/accident",  
             method:"POST",  
             data:$('#accidentform').serialize(),  
             beforeSend:function(){  
                  $('#fetch').val("Fetching...");  
             },
