                        ...
                        <ul class="nav navbar-nav">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="#" onclick="exportTableToCSV('General Report.csv')" id="excel" class="excel" style="color:#006600"><i class="fa fa-file-excel-o"></i> {{__('To Excel')}}</a></li>
                                    <li><a href="#" onclick="display()" class="word" style="color:blue"><i class="fa fa-print"></i> {{__('To Print')}}</a></li>
                                </ul>
                            </li>
                        </ul>
                    </nav>
                    <div class="panel-heading" style="padding-top: 6px;">{{trans('Report')}} - {{trans('General (Monthly)')}}</div>
